...
namespace Proyecto_Topicos
{
    public partial class InfoTelefonoNegro : Form
    {
        ...
        public void LlenarDGV(int ID)
        {
            using (conexion)
            {
                string Consulta = "Select * from Peliculas where ID = @ID";
        ...
        private void InfoTelefonoNegro_Load(object sender, EventArgs e)
        {
